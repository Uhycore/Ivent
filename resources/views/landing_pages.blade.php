...
<body>
    ...
    <div class="auth-buttons">
        ...
        @else
            <!-- Jika belum login -->
            <button onclick="openLogin()" type="button" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">
                Login
            </button>
        @endif
    </div>
    ...
    <section class="about">
        ...
        <div class="about-right">
            ...
            <h4 class="about-3" data-aos="fade-right" data-aos-duration="1000">Ivent adalah platform event digital yang memudahkan kamu untuk menemukan, mendaftar, dan mengikuti berbagai acara menarik seperti seminar, konser, festival, dan olahraga—semua dalam satu tempat, cepat dan praktis.</h4>
            <div class="burger-about">
                <div class="ba-1" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div class="content">
                        ...
                        <div class="ba-3">
                            Ivent hanya menampilkan event yang telah dikurasi dengan baik, sehingga pengguna mendapatkan pengalaman terbaik di setiap acara.
                        </div>
                    </div>
                </div>
                <div class="ba-1" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div class="content">
                        ...
                        <div class="ba-3">
                            Proses daftar event di Ivent mudah, tanpa ribet. Kamu bisa melihat detail event, lokasi, dan fasilitas dengan jelas sebelum mendaftar.
                        </div>
                    </div>
                </div>
                <div class="ba-1" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <div class="content">
                        ...
                        <div class="ba-3">
                            Dengan mengikuti event melalui Ivent, kamu turut mendukung komunitas, UMKM, dan para kreator lokal yang menghadirkan acara penuh inspirasi.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <img src="{{ asset('storage/' . $event->gambar) }}" alt="{{ $event->nama_event }}" class="event-image" />
    <div class="event-info">
        <h3 class="event-title">{{ $event->nama_event }}</h3>
        <h3 class="location">{{ $event->lokasi }}, <span class="date">{{ \Carbon\Carbon::parse($event->tanggal)->format('d-m-Y') }}</span></h3>
        <button class="btn-daftar">
            <a href="#" onclick="opendaftar({{ $event->id }})">Daftar</a>
        </button>
...
@endforeach
    ...
    <sectionc class="testimoni-container">
        ...
        <!-- Card 1 -->
         <div class="card-testi" >
             ...
             <div class="testimoni-card" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100" data-aos-duration="1000">
             ...
             <!-- Card 2 -->
             <div class="testimoni-card" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="200" data-aos-duration="1000">
             ...
             <!-- Card 3 -->
             <div class="testimoni-card" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom"  data-aos-delay="300" data-aos-duration="1000">
             ...
             <!-- Card 4 -->
             <div class="testimoni-card" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom"  data-aos-delay="400" data-aos-duration="1000">
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <p class="footer-desc">
                Temukan berbagai event menarik di sekitarmu dengan mudah dan cepat. Ivent menghubungkan kamu dengan pengalaman tak terlupakan.
            </p>
            </div>
